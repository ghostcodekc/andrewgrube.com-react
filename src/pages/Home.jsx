    ...
    <div className="flex flex-col items-center text-center max-w-2xl mx-auto space-y-12">
      ...
      <div className="flex flex-col items-center space-y-6">
        <div className="group relative w-32 h-32 sm:w-40 sm:h-40">
          <div className="absolute inset-0 bg-emerald-500/20 rounded-full blur-2xl group-hover:bg-emerald-500/40 transition-all duration-500" />
          <img 
            src={data.profile.avatar} 
            alt="Profile" 
            className="relative z-10 rounded-full w-full h-full object-cover border-2 border-zinc-800 shadow-2xl group-hover:border-emerald-500/50 transition-colors duration-500"
          />
        </div>
